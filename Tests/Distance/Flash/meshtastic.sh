...
function flashConfiguration()
{
    ...
    mesh --set lora.modem_preset $option # Porté et débit
...
then
    ...
    then
        ...
        echo "Quelle configuration voulez vous flash (LONG_FAST/MEDIUM_FAST/SHORT_FAST/SHORT_TURBO) ?";
        echo -n "> ";
        read option;

        # Vérifie que l'option est supporté
        ...
        then
            ...
            echo "Option non supporté par la configuration Meshtastic.";
        fi;
